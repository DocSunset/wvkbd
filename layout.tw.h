...
static struct key keys_tw[], keys_twsym[], keys_m8c[], keys_full[], keys_special[], keys_simple[], keys_simplegrid[],
...
static struct layout layouts[NumLayouts] = {
  [TW] = {keys_tw, "latin", "tw"},
  [TWsym] = {keys_twsym, "latin", "twsym"},
  [m8c] = {keys_m8c, "latin", "m8c"},
